...
if (isset($_POST['inserir'])) {
    ...
    if (!is_numeric($preco) || $preco <= 0) {
        $mensagem .= "<p class='erro'>Digite um preço válido.</p>";
        $erro = true;
    }
...
if (!$erro) {
    ...
    if ($conexao->query($sql)) {
        ...
        $mensagem = "<p class='erro'>Erro ao cadastrar: " . $conexao->error . "</p>";
    }
}
}
?>
    ...
    <div class="card">
        ...
        <form method="post">
            ...
            <div class="row">
                <div class="field">
                    <label>Preço (R$)</label>
                    <input name="preco" type="number" step="0.01" min="0" placeholder="0,00" required
